...
import Pyramid from "../components/templates-pyramids/Pyramid";
    ...
    <>
      <div id="" className="p-10 text-white ">
        <button
          ...
          className="fixed bottom-10 border right-10 max-w-sm px-2 py-3 rounded-md bg-green-500"
        >
          Descargar Piramide
        </button>
        <BreadCrumb />
        <HeaderTemplates setTypePyramid={setTypePyramid} />
        <div id="capture" className="grid place-content-center bg-green-300 mb-7">
          {/* <div
            id="accordion-color"
