  ...
  return (
    <div className="px-32 pb-56 ">
      <div className="flex w-full  justify-between items-center gap-5 mb-4">
        <p className="text-lg flex flex-col justify-end font-semibold"></p>
        <div className="flex gap-5 ">
          ...
          <button
            onClick={() => setControllerAnimation(!controllerAnimation)}
            className="btnPrimary font-medium  hover:bg-white/50"
          >
            Volver a sortear
          </button>
          <BackButton />
